    ...
    <div className="min-h-screen bg-gray-50">
      <div className="relative">
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          ...
          {/* Sección de redes sociales y compartir */}
          <SocialActions restaurantConfig={restaurantConfig} />
        </main>
        ...
        <footer className="footer-gastronomico text-center p-6 w-full mt-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
              {/* Texto del desarrollador más pequeño */}
              <p className="footer-texto text-sm">
                Desarrollado por{' '}
                <a 
                  href={restaurantConfig.developerUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="developer-link text-amber-900 hover:text-amber-700 transition-colors duration-300"
                >
                  4x
                </a>
              </p>
              ...
              <a 
                className="footer-link-compact inline-flex items-center px-4 py-2 rounded-lg hover:bg-gray-800 transition-all duration-300"
                href={`https://api.whatsapp.com/send?phone=${restaurantConfig.whatsappPhone}&text=${encodeURIComponent(restaurantConfig.whatsappContactMessage)}`}
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg 
